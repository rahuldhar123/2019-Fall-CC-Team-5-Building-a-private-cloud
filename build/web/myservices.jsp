...
<%
    ...
    <script>
        if(!<%=username%>)
            window.location = "/Cloud/login_wp.html";
    </script>
...
<div class="hfeed site" id="page">
	<a class="skip-link screen-reader-text" href="#content">Skip to content</a>
		...
		<header class="site-header header-main-layout-1 ast-primary-menu-enabled ast-menu-toggle-icon ast-mobile-header-stack" itemtype="https://schema.org/WPHeader" itemscope="itemscope" id="masthead" role="banner">
	...
	<div class="main-header-bar">
		...
		<div class="site-branding">
			<div class="ast-site-identity" itemscope="itemscope" itemtype="https://schema.org/Organization">
				<span class="site-logo-img"><a href="http://192.168.1.251/" class="custom-logo-link" rel="home"><script data-pagespeed-no-defer>//<![CDATA[
...
//]]></script><img width="54" height="54" src="http://192.168.1.251/wp-content/uploads/2019/10/docker-1-54x54.png" class="custom-logo" alt="user&#039;s Blog!" data-pagespeed-url-hash="3937648321" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/></a></span><div class="ast-site-title-wrap">
							
							<p class="site-description" itemprop="description">
					Building PaaS through IaaS
				</p>
						</div>			</div>
		</div>
		...
		<!-- .site-branding -->
			...
			<button type="button" class="menu-toggle main-header-menu-toggle  ast-mobile-menu-buttons-fill " aria-controls='primary-menu'>
...
<li id="menu-item-1182" class="menu-item menu-item-type-post_type menu-item-object-page current_page_item menu-item-1182"><a href="myservices.jsp">My Services</a></li>
<li id="menu-item-1168" class="menu-item menu-item-type-post_type menu-item-object-page  page_item page-item-1095 menu-item-1168"><a href="logout.jsp">Logout</a></li>
	...
	<div class="entry-content clear" itemprop="text">
			...
			<div class="elementor-inner">
				<div class="elementor-section-wrap">
							<section class="elementor-element elementor-element-972a5ae elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section" data-id="972a5ae" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
				<div class="elementor-row">
				<div class="elementor-element elementor-element-e8eabd0 elementor-column elementor-col-100 elementor-top-column" data-id="e8eabd0" data-element_type="column">
			<div class="elementor-column-wrap  elementor-element-populated">
					<div class="elementor-widget-wrap">
				<div class="elementor-element elementor-element-662a19c elementor-widget elementor-widget-spacer" data-id="662a19c" data-element_type="widget" data-widget_type="spacer.default">
			...
			<div class="elementor-spacer-inner"></div>
				...
				<div class="elementor-element elementor-element-4229c07 elementor-widget elementor-widget-heading" data-id="4229c07" data-element_type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
        ...
        for (Document user : users) {
            ...
            for (Document container : containers) 
            {
                ...
                %>
                				...
                				<section class="elementor-element elementor-element-f3dbc2d elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section" data-id="f3dbc2d" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
				<div class="elementor-row">
				<div class="elementor-element elementor-element-8c8f052 elementor-column elementor-col-33 elementor-top-column" data-id="8c8f052" data-element_type="column">
			<div class="elementor-column-wrap  elementor-element-populated">
					<div class="elementor-widget-wrap">
				<div class="elementor-element elementor-element-1c4f7b8 elementor-widget elementor-widget-text-editor" data-id="1c4f7b8" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
					<div class="elementor-text-editor elementor-clearfix">                <p style="font-size:25px;"><a href=<%= url %> target="_blank"
                      ><%= url %></a></p></div>
				</div>
				</div>
						</div>
				...
				<div class="elementor-element elementor-element-796d25c elementor-column elementor-col-33 elementor-top-column" data-id="796d25c" data-element_type="column">
			<div class="elementor-column-wrap  elementor-element-populated">
					<div class="elementor-widget-wrap">
				<div class="elementor-element elementor-element-5d5c8fb elementor-widget elementor-widget-button" data-id="5d5c8fb" data-element_type="widget" data-widget_type="button.default">
				<div class="elementor-widget-container">
					<div class="elementor-button-wrapper">
			<a href="/Cloud/deleteContainer.jsp?id=<%=container.getString("id")%>&userid=<%=session.getAttribute("userid")%>"  class="elementor-button-link elementor-button elementor-size-sm" role="button">
						<span class="elementor-button-content-wrapper">
						<span class="elementor-button-text" id=<%=container.getString("id")%>>Delete Container</span>
		</span>
					</a>
		</div>
				</div>
...
%>                                     
				...
				<section class="elementor-element elementor-element-86e79db elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section" data-id="86e79db" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
				<div class="elementor-row">
				<div class="elementor-element elementor-element-2f74d67 elementor-column elementor-col-100 elementor-top-column" data-id="2f74d67" data-element_type="column">
			<div class="elementor-column-wrap  elementor-element-populated">
					<div class="elementor-widget-wrap">
				<div class="elementor-element elementor-element-b476463 elementor-widget elementor-widget-spacer" data-id="b476463" data-element_type="widget" data-widget_type="spacer.default">
				<div class="elementor-widget-container">
					<div class="elementor-spacer">
			<div class="elementor-spacer-inner"></div>
		</div>
			...
			<div class="elementor-column-wrap  elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<div class="elementor-button-wrapper">
			<a href="/Cloud/createContainer.jsp?userid=<%=session.getAttribute("userid")%>" class="elementor-button-link elementor-button elementor-size-sm" role="button">
						<span class="elementor-button-content-wrapper">
						<span class="elementor-button-text">Create Containers</span>
		</span>
					</a>
		</div>
				</div>
